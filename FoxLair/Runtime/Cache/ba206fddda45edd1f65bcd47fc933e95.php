...
<link href="__PUBLIC__/styles.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<ul class="round">
			<li><img src="__PUBLIC__/images/header1.jpg" alt="" /></li>
			<li><img src="__PUBLIC__/images/header2.jpg" alt="" /></li>
			<li><img src="__PUBLIC__/images/header3.jpg" alt="" /></li>
			<li><img src="__PUBLIC__/images/header4.jpg" alt="" /></li>
			<li><img src="__PUBLIC__/images/header5.jpg" alt="" /></li>
			<li><img src="__PUBLIC__/images/header6.jpg" alt="" /></li>
</ul>
<script type="text/javascript" src="__PUBLIC__/lib/jquery.js"></script>
<script type="text/javascript" src="__PUBLIC__/lib/jquery.roundabout.js"></script>
<script type="text/javascript">
       			...
       			<div id="content">
                    <div class="cont_home">
                    	<div class="home_box">
                        	...
                        	<img src="__PUBLIC__/images/img11.jpg" alt="" />
                        ...
                        <div class="home_box">
                            ...
                            <div style="height:15px"></div>
                        	<img src="__PUBLIC__/images/img12.jpg" alt="" />
                        	<div style="height:10px;"></div>
                      ...
                      <div class="home_box">
                            ...
                            <div style="height:15px"></div>
                        	<img src="__PUBLIC__/images/img13.jpg" alt="" />
                            <div style="height:10px;"></div>
    ...
    <div id="b_col1">
      ...
      <div id="b_col2">
        	...
        	<div style="height:15px"></div>
            <img src="__PUBLIC__/images/img14.jpg" class="img_l" alt="" />
			...
			<img src="__PUBLIC__/images/img15.jpg" class="img_l" alt="" />
